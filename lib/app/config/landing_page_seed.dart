...
class LandingPageSeed {
  ...
  static final LandingPageConfig fallbackConfig = LandingPageConfig(
    ...
    heroHighlightLabel: 'Ready-Made Posters Available',
    heroImageUrl: '',
    ...
    plansSubtitle:
        'Choose a simple plan for daily poster creation, clean exports, and faster personalization.',
    plansPrimaryCtaLabel: 'View Plan',
    faqEyebrow: 'FAQ',
  ...
  firestoreLandingPageDocument = <String, Object?>{
    'showHero': true,
    'showPreview': true,
    'showFeatures': true,
    'showCategories': true,
  ...
  static final List<Map<String, Object?>> firestoreWebsitePosters =
      <Map<String, Object?>>[];
