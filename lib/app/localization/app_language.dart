...
const Map<String, String> _cleanTeluguUiFallbacks = <String, String>{
  ...
  'Photos, storage and other access':
      '\u0C2B\u0C4B\u0C1F\u0C4B\u0C32\u0C41, \u0C38\u0C4D\u0C1F\u0C4B\u0C30\u0C47\u0C1C\u0C4D \u0C2E\u0C30\u0C3F\u0C2F\u0C41 \u0C07\u0C24\u0C30 \u0C2F\u0C3E\u0C15\u0C4D\u0C38\u0C46\u0C38\u0C4D',
  'Control alerts and updates':
      '\u0C05\u0C32\u0C30\u0C4D\u0C1F\u0C4D\u0C32\u0C41 \u0C2E\u0C30\u0C3F\u0C2F\u0C41 \u0C05\u0C2A\u0C4D\u0C21\u0C47\u0C1F\u0C4D\u0C32\u0C28\u0C41 \u0C28\u0C3F\u0C2F\u0C02\u0C24\u0C4D\u0C30\u0C3F\u0C02\u0C1A\u0C02\u0C21\u0C3F',
  'Help & Support':
      '\u0C38\u0C39\u0C3E\u0C2F\u0C02 & \u0C38\u0C2A\u0C4B\u0C30\u0C4D\u0C1F\u0C4D',
  'Get help and contact support':
      '\u0C38\u0C39\u0C3E\u0C2F\u0C02 \u0C2A\u0C4A\u0C02\u0C26\u0C02\u0C21\u0C3F \u0C2E\u0C30\u0C3F\u0C2F\u0C41 \u0C38\u0C2A\u0C4B\u0C30\u0C4D\u0C1F\u0C4D\u0C28\u0C41 \u0C38\u0C02\u0C2A\u0C4D\u0C30\u0C26\u0C3F\u0C02\u0C1A\u0C02\u0C21\u0C3F',
  'About App':
      '\u0C2F\u0C3E\u0C2A\u0C4D \u0C17\u0C41\u0C30\u0C3F\u0C02\u0C1A\u0C3F',
  'App details and version info':
      '\u0C2F\u0C3E\u0C2A\u0C4D \u0C35\u0C3F\u0C35\u0C30\u0C3E\u0C32\u0C41 \u0C2E\u0C30\u0C3F\u0C2F\u0C41 \u0C35\u0C46\u0C30\u0C4D\u0C37\u0C28\u0C4D \u0C38\u0C2E\u0C3E\u0C1A\u0C3E\u0C30\u0C02',
  'Logout': '\u0C32\u0C3E\u0C17\u0C4C\u0C1F\u0C4D',
  'Current language':
      '\u0C2A\u0C4D\u0C30\u0C38\u0C4D\u0C24\u0C41\u0C24 \u0C2D\u0C3E\u0C37',
  'Save / Apply': '\u0C38\u0C47\u0C35\u0C4D / \u0C05\u0C2A\u0C4D\u0C32\u0C48',
  'Could not open the link. Please try again.':
      '\u0C32\u0C3F\u0C02\u0C15\u0C4D \u0C24\u0C46\u0C30\u0C35\u0C32\u0C47\u0C15\u0C2A\u0C4B\u0C2F\u0C3E\u0C02. \u0C2E\u0C33\u0C4D\u0C32\u0C40 \u0C2A\u0C4D\u0C30\u0C2F\u0C24\u0C4D\u0C28\u0C3F\u0C02\u0C1A\u0C02\u0C21\u0C3F.',
  'Crop Photo': '\u0C2B\u0C4B\u0C1F\u0C4B \u0C15\u0C4D\u0C30\u0C3E\u0C2A\u0C4D',
  'Crop Logo': '\u0C32\u0C4B\u0C17\u0C4B \u0C15\u0C4D\u0C30\u0C3E\u0C2A\u0C4D',
  'Personal photo update failed':
      '\u0C2A\u0C30\u0C4D\u0C38\u0C28\u0C32\u0C4D \u0C2B\u0C4B\u0C1F\u0C4B \u0C05\u0C2A\u0C4D\u0C21\u0C47\u0C1F\u0C4D \u0C15\u0C3E\u0C32\u0C47\u0C26\u0C41',
  'Business logo update failed':
      '\u0C2C\u0C3F\u0C1C\u0C3F\u0C28\u0C46\u0C38\u0C4D \u0C32\u0C4B\u0C17\u0C4B \u0C05\u0C2A\u0C4D\u0C21\u0C47\u0C1F\u0C4D \u0C15\u0C3E\u0C32\u0C47\u0C26\u0C41',
  'Profile saved':
      '\u0C2A\u0C4D\u0C30\u0C4A\u0C2B\u0C48\u0C32\u0C4D \u0C38\u0C47\u0C35\u0C4D \u0C05\u0C2F\u0C3F\u0C02\u0C26\u0C3F',
  'Profile details could not be saved':
      '\u0C2A\u0C4D\u0C30\u0C4A\u0C2B\u0C48\u0C32\u0C4D \u0C35\u0C3F\u0C35\u0C30\u0C3E\u0C32\u0C41 \u0C38\u0C47\u0C35\u0C4D \u0C15\u0C3E\u0C32\u0C47\u0C26\u0C41',
  'Poster Profile':
      '\u0C2A\u0C4B\u0C38\u0C4D\u0C1F\u0C30\u0C4D \u0C2A\u0C4D\u0C30\u0C4A\u0C2B\u0C48\u0C32\u0C4D',
  'My Downloads':
      '\u0C28\u0C3E \u0C21\u0C4C\u0C28\u0C4D\u200C\u0C32\u0C4B\u0C21\u0C4D\u0C32\u0C41',
  ...
  'Enter your designation':
      '\u0C2E\u0C40 \u0C39\u0C4B\u0C26\u0C3E \u0C28\u0C2E\u0C4B\u0C26\u0C41 \u0C1A\u0C47\u0C2F\u0C02\u0C21\u0C3F',
  'Business Details':
      '\u0C2C\u0C3F\u0C1C\u0C3F\u0C28\u0C46\u0C38\u0C4D \u0C35\u0C3F\u0C35\u0C30\u0C3E\u0C32\u0C41',
  'Business Name':
      '\u0C2C\u0C3F\u0C1C\u0C3F\u0C28\u0C46\u0C38\u0C4D \u0C2A\u0C47\u0C30\u0C41',
  'Enter business name':
      '\u0C2C\u0C3F\u0C1C\u0C3F\u0C28\u0C46\u0C38\u0C4D \u0C2A\u0C47\u0C30\u0C41 \u0C28\u0C2E\u0C4B\u0C26\u0C41 \u0C1A\u0C47\u0C2F\u0C02\u0C21\u0C3F',
  'Business Tagline':
      '\u0C2C\u0C3F\u0C1C\u0C3F\u0C28\u0C46\u0C38\u0C4D \u0C1F\u0C4D\u0C2F\u0C3E\u0C17\u0C4D\u200C\u0C32\u0C48\u0C28\u0C4D',
  'Optional short line':
      '\u0C10\u0C1A\u0C4D\u0C1B\u0C3F\u0C15 \u0C1A\u0C3F\u0C28\u0C4D\u0C28 \u0C32\u0C48\u0C28\u0C4D',
  'Business WhatsApp Number':
      '\u0C2C\u0C3F\u0C1C\u0C3F\u0C28\u0C46\u0C38\u0C4D \u0C35\u0C3E\u0C1F\u0C4D\u0C38\u0C3E\u0C2A\u0C4D \u0C28\u0C02\u0C2C\u0C30\u0C4D',
  '10-digit number':
      '10 \u0C05\u0C02\u0C15\u0C46\u0C32 \u0C28\u0C02\u0C2C\u0C30\u0C4D',
  'Logo Style': '\u0C32\u0C4B\u0C17\u0C4B \u0C38\u0C4D\u0C1F\u0C48\u0C32\u0C4D',
  'Mana Business':
      '\u0C2E\u0C28 \u0C2C\u0C3F\u0C1C\u0C3F\u0C28\u0C46\u0C38\u0C4D',
  'Profile Photos':
      '\u0C2A\u0C4D\u0C30\u0C4A\u0C2B\u0C48\u0C32\u0C4D \u0C2B\u0C4B\u0C1F\u0C4B\u0C32\u0C41',
  ...
  'Could not crop saved profile photo.':
      '\u0C38\u0C47\u0C35\u0C4D \u0C1A\u0C47\u0C38\u0C3F\u0C28 \u0C2A\u0C4D\u0C30\u0C4A\u0C2B\u0C48\u0C32\u0C4D \u0C2B\u0C4B\u0C1F\u0C4B \u0C15\u0C4D\u0C30\u0C3E\u0C2A\u0C4D \u0C15\u0C3E\u0C32\u0C47\u0C26\u0C41.',
};
...
class AppStrings {
  ...
  String get freeExportWithPhotoMessage => localized(
    telugu:
        '\u0c2b\u0c4b\u0c1f\u0c4b, \u0c2a\u0c47\u0c30\u0c41 \u0c24\u0c4b \u0c37\u0c47\u0c30\u0c4d \u0c1a\u0c47\u0c2f\u0c02\u0c21\u0c3f',
    english: 'Share with photo and name',
    hindi:
        '\u092b\u094b\u091f\u094b \u0914\u0930 \u0928\u093e\u092e \u0915\u0947 \u0938\u093e\u0925 \u0936\u0947\u092f\u0930 \u0915\u0930\u0947\u0902',
  );
  ...
  String get freeExportPlainMessage => localized(
    telugu:
        '\u0c2a\u0c47\u0c30\u0c41, \u0c2b\u0c4b\u0c1f\u0c4b \u0c32\u0c47\u0c15\u0c41\u0c02\u0c21\u0c3e \u0c15\u0c47\u0c35\u0c32\u0c02 \u0c2a\u0c4b\u0c38\u0c4d\u0c1f\u0c30\u0c4d',
    english: 'Poster only without name and photo',
    hindi:
        '\u0928\u093e\u092e \u0914\u0930 \u092b\u094b\u091f\u094b \u0915\u0947 \u092c\u093f\u0928\u093e \u0938\u093f\u0930\u094d\u092b \u092a\u094b\u0938\u094d\u091f\u0930',
  );
