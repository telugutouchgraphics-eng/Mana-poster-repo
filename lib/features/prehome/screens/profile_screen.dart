              ...
              items: <_ProfileItemData>[
                ...
                _ProfileItemData(
                  ...
                  subtitle: context.strings.localized(
                    ...
                    malayalam:
                        '3 പ്രൊഫഷണൽ ഡിസൈനുകൾ • പ്രിന്റ് ചെയ്യാവുന്ന വലുപ്പം',
...
class _ProfileCopy {
  ...
  String get stateSavedMessage => _localized(
    ...
    kashmiri:
        'ریاست گٔیہٕ اپ ڈیٹ۔ مہربٲنی کٔرتھ کٔریو سیاسی پارٹین ہُنٛد جائزہ',
  ...
  String get politicalPartySubtitle => _localized(
    ...
    malayalam:
        'ഹോമിൽ കാണിക്കുന്ന രാഷ്ട്രീയ പാർട്ടി വിഭാഗങ്ങൾ അപ്ഡേറ്റ് ചെയ്യുക',
    ...
    punjabi:
        'ਹੋਮ ਵਿੱਚ ਦਿਖਾਈ ਦੇਣ ਵਾਲੀਆਂ ਸਿਆਸੀ ਪਾਰਟੀਆਂ ਦੀਆਂ ਸ਼੍ਰੇਣੀਆਂ ਅੱਪਡੇਟ ਕਰੋ',
  ...
  String get referralCodeApplyFailedMessage => _localized(
    ...
    kashmiri:
        'ریفرل کوڈ لاگوٗ کرنہٕ منز ناکامی۔ مہربٲنی کٔرتھ دۆبارٕ کٔریو کوشِش۔',
  ...
  String get reportIssueSubtitle => _localized(
    ...
    tamil:
        'பொருத்தமற்ற போஸ்டர் அல்லது செயலி சிக்கல் அறிக்கையை ஆதரவுக்கு அனுப்பவும்',
    kannada: 'ಅನುಚಿತ ಪೋಸ್ಟರ್ ಅಥವಾ ಆಪ್ ಸಮಸ್ಯೆ ವರದಿಯನ್ನು ಬೆಂಬಲಕ್ಕೆ ಕಳುಹಿಸಿ',
    malayalam:
        'അനുചിതമായ പോസ്റ്ററോ ആപ്പ് പ്രശ്ന റിപ്പോർട്ടോ പിന്തുണയ്ക്ക് അയയ്ക്കുക',
...
''',
  ...
  String get deleteAccountSubtitle => _localized(
    ...
    malayalam:
        'നിങ്ങളുടെ അക്കൗണ്ടും ഡാറ്റയും നീക്കംചെയ്യാനുള്ള അഭ്യർത്ഥന ആരംഭിക്കുക',
