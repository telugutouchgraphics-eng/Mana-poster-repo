...
class _HelpSupportCopy {
  ...
  static const Map<String, Map<AppLanguage, String>> _helpDictionary = {
    ...
    'Find quick answers for login, photo import, save/export, subscription, and other common app issues. Posters shown in the app are reviewed before publishing.': {
      AppLanguage.hindi:
          'लॉगिन, फ़ोटो चयन, सहेजें/निर्यात, सदस्यता और अन्य ऐप समस्याओं के त्वरित उत्तर यहाँ पाएँ। ऐप में दिखाए गए पोस्टर प्रकाशन से पहले समीक्षित होते हैं।',
      AppLanguage.tamil:
          'உள்நுழைவு, புகைப்படத் தேர்வு, சேமி/ஏற்றுமதி, சந்தா மற்றும் பிற சிக்கல்களுக்கு விரைவான பதில்கள். பயன்பாட்டில் காட்டப்படும் போஸ்டர்கள் வெளியீட்டிற்கு முன் மதிப்பாய்வு செய்யப்படுகின்றன.',
      AppLanguage.kannada:
          'ಲಾಗಿನ್, ಫೋಟೋ ಆಯ್ಕೆ, ಸೇವ್/ರಫ್ತು, ಚಂದಾದಾರಿಕೆ ಮತ್ತು ಇತರ ಸಾಮಾನ್ಯ ಸಮಸ್ಯೆಗಳಿಗೆ ತ್ವರಿತ ಉತ್ತರಗಳನ್ನು ಇಲ್ಲಿ ಹುಡುಕಿ. ಆಪ್‌ನಲ್ಲಿ ತೋರಿಸುವ ಪೋಸ್ಟರ್‌ಗಳನ್ನು ಪ್ರಕಟಣೆಗೆ ಮೊದಲು ಪರಿಶೀಲಿಸಲಾಗುತ್ತದೆ.',
      AppLanguage.malayalam:
          'ലോഗിൻ, ഫോട്ടോ ഇറക്കുമതി, സേവ്/എക്‌സ്‌പോർട്ട്, സബ്‌സ്‌ക്രിപ്ഷൻ, മറ്റ് ആപ്പ് പ്രശ്നങ്ങൾ എന്നിവയ്ക്കുള്ള ദ്രുത ഉത്തരങ്ങൾ കണ്ടെത്തുക. ആപ്പിലെ പോസ്റ്ററുകൾ പ്രസിദ്ധീകരിക്കുന്നതിന് മുമ്പ് അവലോകനം ചെയ്യപ്പെടുന്നു.',
      AppLanguage.marathi:
          'लॉगिन, फोटो आयात, जतन/निर्यात, सदस्यता आणि इतर अ‍ॅप समस्यांसाठी जलद उत्तरे मिळवा. अ‍ॅपमधील पोस्टर्स प्रकाशनापूर्वी तपासले जातात.',
      AppLanguage.gujarati:
          'લૉગિન, ફોટો આયાત, સાચવો/નિકાસ, સબ્સ્ક્રિપ્શન અને અન્ય એપ્લિકેશન સમસ્યાઓ માટે ઝડપી જવાબો શોધો. એપ્લિકેશનમાં દર્શાવેલ પોસ્ટર્સ પ્રકાશન પહેલાં સમીક્ષા કરવામાં આવે છે.',
      AppLanguage.bengali:
          'লগইন, ফটো আমদানি, সেভ/এক্সপোর্ট, সাবস্ক্রিপশন এবং অন্যান্য সাধারণ সমস্যার দ্রুত উত্তর খুঁজুন। অ্যাপে প্রদর্শিত পোস্টার প্রকাশের আগে পর্যালোচনা করা হয়।',
      AppLanguage.punjabi:
          'ਲੌਗਇਨ, ਫੋਟੋ ਆਯਾਤ, ਸੇਵ/ਨਿਰਯਾਤ, ਸਬਸਕ੍ਰਿਪਸ਼ਨ ਅਤੇ ਹੋਰ ਐਪ ਮੁੱਦਿਆਂ ਲਈ ਤੁਰੰਤ ਜਵਾਬ ਲੱਭੋ। ਐਪ ਵਿੱਚ ਦਿਖਾਏ ਗਏ ਪੋਸਟਰ ਪ੍ਰਕਾਸ਼ਨ ਤੋਂ ਪਹਿਲਾਂ ਸਮੀਖਿਆ ਕੀਤੇ ਜਾਂਦੇ ਹਨ।',
      AppLanguage.odia:
          'ଲଗଇନ୍, ଫଟୋ ଚୟନ, ସେଭ୍/ରପ୍ତାନି, ସବସ୍କ୍ରିପସନ୍ ଏବଂ ଅନ୍ୟାନ୍ୟ ସମସ୍ୟା ପାଇଁ ଶୀଘ୍ର ଉତ୍ତର ଖୋଜନ୍ତୁ। ପ୍ରକାଶନ ପୂର୍ବରୁ ପୋଷ୍ଟରଗୁଡ଼ିକ ସମୀକ୍ଷା କରାଯାଏ।',
      AppLanguage.assamese:
          'লগইন, ফটো আমদানি, সংৰক্ষণ/ৰপ্তানি, গ্ৰাহকভুক্তি আৰু অন্যান্য সমস্যাৰ তাৎক্ষণিক উত্তৰ লাভ কৰক। প্ৰকাশৰ পূৰ্বে পোষ্টাৰসমূহ পৰ্যালোচনা কৰা হয়।',
      AppLanguage.konkani:
          'लॉगिन, फोटो आयात, सांबाळप/निर्यात, वर्गणी आनी हेर अडचणींक बेगीन जाप मेळोवच्यो. अ‍ॅपांत दाखयिल्लीं पोस्टरां छापने पयलीं तपासतात.',
      AppLanguage.nepali:
          'लगइन, फोटो आयात, सुरक्षित/निर्यात, सदस्यता र अन्य एप समस्याहरूको द्रुत जवाफ खोज्नुहोस्। एपमा देखाइएका पोस्टरहरू प्रकाशन अघि समीक्षा गरिन्छ।',
      AppLanguage.meitei:
          'Login, photo import, save/export, subscription amasung atei awabasinggi thuna paokhum thengnasi. App da phongba postering publish toudringeida review tou-i.',
      AppLanguage.mizo:
          'Login, thlalak lakluh, save/export, subscription leh harsatna dang chhanna heta tang hian hmu rawh. Poster zawng zawng chhuah hma in endik vek a ni.',
      AppLanguage.kashmiri:
          'لاگ اِن، فوٹو اِمپورٹ، سیو/ایکسپورٹ، سبسکرپشن تہٕ باقٕے عام مسلن ہٕندِ فوری جواب لبِو ییٚتھ۔ شایع گژھنہٕ برونٛٹھ گژھن پوسٹر چیک۔',
      AppLanguage.ladakhi:
          'Login དང་ པར་ལེན་པ། ཉར་ཚགས། ཕྱིར་འདྲེན། མཁོ་སྤྲོད་སོགས་ཀྱི་དཀའ་ངལ་གྱི་ལན་མགྱོགས་མྱུར་དུ་འཚོལ།',
    },
    'Privacy and terms': {
    ...
    'Read the app privacy policy and terms of use here.': {
      ...
      AppLanguage.tamil:
          'செயலி தனியுரிமைக் கொள்கை மற்றும் பயன்பாட்டு விதிமுறைகளை இங்கே படிக்கவும்.',
      AppLanguage.kannada: 'ಆಪ್ ಗೌಪ್ಯತಾ ನೀತಿ ಮತ್ತು ಬಳಕೆಯ ನಿಯಮಗಳನ್ನು ಇಲ್ಲಿ ಓದಿ.',
      AppLanguage.malayalam:
          'ആപ്പ് സ്വകാര്യതാ നയവും ഉപയോഗ നിబంధനകളും ഇവിടെ വായിക്കുക.',
      AppLanguage.marathi: 'अ‍ॅप गोपनीयता धोरण आणि वापराच्या अटी येथे वाचा.',
      AppLanguage.gujarati:
          'એપ્લિકેશન ગોપનીયતા નીતિ અને ઉપયોગની શરતો અહીં વાંચો.',
      AppLanguage.bengali:
          'অ্যাপ গোপনীয়তা নীতি এবং ব্যবহারের শর্তাবলী এখানে পড়ুন।',
      ...
      AppLanguage.assamese:
          'এপ গোপনীয়তা নীতি আৰু ব্যৱহাৰৰ চৰ্তাৱলী ইয়াত পঢ়ক।',
      ...
      AppLanguage.mizo:
          'App privacy policy leh hman dan tur dan te heta tang hian chhiar rawh.',
    ...
    'Email us with the issue details. If you opened a question above, that context will also be added to the draft email.': {
      AppLanguage.hindi:
          'समस्या विवरण के साथ हमें ईमेल करें। यदि आपने ऊपर कोई प्रश्न खोला है, तो वह संदर्भ भी ड्राफ्ट ईमेल में जुड़ जाएगा।',
      AppLanguage.tamil:
          'சிக்கல் விவரங்களுடன் எங்களுக்கு மின்னஞ்சல் அனுப்பவும். மேலே ஒரு கேள்வியைத் திறந்திருந்தால், அந்த விவரமும் சேர்க்கப்படும்.',
      AppLanguage.kannada:
          'ಸಮಸ್ಯೆಯ ವಿವರಗಳೊಂದಿಗೆ ನಮಗೆ ಇಮೇಲ್ ಮಾಡಿ. ನೀವು ಮೇಲೆ ಪ್ರಶ್ನೆಯನ್ನು ತೆರೆದಿದ್ದರೆ, ಆ ವಿವರವೂ ಡ್ರಾಫ್ಟ್ ಇಮೇಲ್‌ನಲ್ಲಿ ಸೇರಿಸಲ್ಪಡುತ್ತದೆ.',
      AppLanguage.malayalam:
          'പ്രശ്ന വിവരങ്ങളുമായി ഞങ്ങൾക്ക് ഇമെയിൽ ചെയ്യുക. മുകളിലുള്ള ചോദ്യം തുറന്നിട്ടുണ്ടെങ്കിൽ, ആ സന്ദർഭവും ചേർക്കും.',
      AppLanguage.marathi:
          'समस्येच्या तपशीलासह आम्हाला ईमेल करा. तुम्ही वरील प्रश्न उघडल्यास, तो संदर्भ मसुदा ईमेलमध्ये जोडला जाईल.',
      AppLanguage.gujarati:
          'સમસ્યાની વિગતો સાથે અમને ઇમેઇલ કરો. જો તમે ઉપર પ્રશ્ન ખોલ્યો હોય, તો તે સંદર્ભ પણ ડ્રાફ્ટ ઇમેઇલમાં ઉમેરવામાં આવશે.',
      AppLanguage.bengali:
          'সমস্যার বিবরণ সহ আমাদের ইমেল করুন। আপনি উপরে কোনো প্রশ্ন খুললে তা ড্রাফ্ট ইমেলে যুক্ত হবে।',
      AppLanguage.punjabi:
          'ਮੁੱਦੇ ਦੇ ਵੇਰਵਿਆਂ ਨਾਲ ਸਾਨੂੰ ਈਮੇਲ ਕਰੋ। ਜੇਕਰ ਤੁਸੀਂ ਉੱਪਰ ਕੋਈ ਸਵਾਲ ਖੋਲ੍ਹਿਆ ਹੈ, ਤਾਂ ਉਹ ਡਰਾਫਟ ਈਮੇਲ ਵਿੱਚ ਸ਼ਾਮਲ ਹੋਵੇਗਾ।',
      AppLanguage.odia:
          'ସମସ୍ୟା ବିବରଣୀ ସହିତ ଆମକୁ ଇମେଲ୍ କରନ୍ତୁ। ଯଦି ଆପଣ ଉପରେ ଏକ ପ୍ରଶ୍ନ ଖୋଲିଛନ୍ତି, ତେବେ ତାହା ଡ୍ରାଫ୍ଟ ଇମେଲରେ ଯୋଡ଼ାଯିବ।',
      AppLanguage.assamese:
          'সমস্যাৰ বিৱৰণ সহ আমালৈ ইমেইল কৰক। আপুনি ওপৰত প্ৰশ্ন বাছিলে সেয়া ড্ৰাফ্ট ইমেইলত যোগ হ’ব।',
      AppLanguage.konkani:
          'समस्येच्या तपशीलांसयत आमकां ईमेल करात. तुमी वयलो प्रस्न उकत केल्यार, तो संदर्भ ड्राफ्ट ईमेलांत जोडटलो.',
      AppLanguage.nepali:
          'समस्याको विवरण सहित हामीलाई इमेल गर्नुहोस्। यदि तपाईंले माथिको प्रश्न खोल्नुभयो भने, त्यो मस्यौदा इमेलमा थपिनेछ।',
      AppLanguage.meitei:
          'Awabagi details ga loina email toubiyu. Mathaktagi wahang khallabadi draft email da yapkhatkani.',
      AppLanguage.mizo:
          'I harsatna min rawn email rawh. Chanchin i thlan kha email draft-ah a lo tel bawk ang.',
      AppLanguage.kashmiri:
          'مسلہٕ کس تفصیلات سٟتۍ کٔریو سانہِ ای میل۔ برونٛٹھ سوالُک سیاق و سباق تہِ گژھہِ شامل۔',
      AppLanguage.ladakhi:
          'དཀའ་ངལ་གྱི་གནས་ཚུལ་དང་བཅས་ཏེ་ང་ཚོར་ email གཏོང་གནང།',
    },
    'Email support': {
    ...
    'Hello Mana Poster Ai team,\n\nIssue details:\n-': {
      AppLanguage.hindi:
          'नमस्ते Mana Poster Ai टीम,\n\nमेरी समस्या का विवरण:\n-',
      AppLanguage.tamil:
          'வணக்கம் Mana Poster Ai குழு,\n\nசிக்கல் விவரங்கள்:\n-',
      AppLanguage.kannada:
          'ನಮಸ್ಕಾರ Mana Poster Ai ತಂಡ,\n\nನನ್ನ ಸಮಸ್ಯೆಯ ವಿವರಗಳು:\n-',
      AppLanguage.malayalam:
          'നമസ്കാരം Mana Poster Ai ടീം,\n\nഎന്റെ പ്രശ്ന വിവരങ്ങൾ:\n-',
      AppLanguage.marathi:
          'नमस्कार Mana Poster Ai टीम,\n\nमाझ्या समस्येचे तपशील:\n-',
      AppLanguage.gujarati:
          'નમસ્તે Mana Poster Ai ટીમ,\n\nમારી સમસ્યાની વિગતો:\n-',
      AppLanguage.bengali:
          'নমস্কার Mana Poster Ai টিম,\n\nআমার সমস্যার বিবরণ:\n-',
      AppLanguage.punjabi:
          'ਸਤਿ ਸ੍ਰੀ ਅਕਾਲ Mana Poster Ai ਟੀਮ,\n\nਮੇਰੀ ਸਮੱਸਿਆ ਦੇ ਵੇਰਵੇ:\n-',
      AppLanguage.odia: 'ନମସ୍କାର Mana Poster Ai ଟିମ୍,\n\nମୋ ସମସ୍ୟାର ବିବରଣୀ:\n-',
      AppLanguage.assamese:
          'নমস্কাৰ Mana Poster Ai দল,\n\nমোৰ সমস্যাৰ বিৱৰণ:\n-',
      AppLanguage.konkani:
          'नमस्कार Mana Poster Ai टिम,\n\nम्हज्या समस्येचो तपशील:\n-',
      AppLanguage.nepali:
          'नमस्ते Mana Poster Ai टोली,\n\nमेरो समस्याको विवरण:\n-',
      AppLanguage.meitei:
          'Khurumjari Mana Poster Ai team,\n\nEigi awabagi details:\n-',
      AppLanguage.mizo:
          'Chibai Mana Poster Ai team,\n\nKa harsatna details:\n-',
      AppLanguage.kashmiri:
          'سلام Mana Poster Ai ٹیم،\n\nمیٚأنۍ مسلہٕ کِس تفصیلات:\n-',
      AppLanguage.ladakhi:
          'འཚམས་འདྲི་ཞུའོ Mana Poster Ai རུ་ཁག\n\nངའི་དཀའ་ངལ་གྱི་གནས་ཚུལ།\n-',
    },
    'Selected topic': {
    ...
    'Could not open the email app. Please use the support email manually.': {
      AppLanguage.hindi:
          'ईमेल ऐप नहीं खुला। कृपया मैन्युअल रूप से सपोर्ट ईमेल का उपयोग करें।',
      AppLanguage.tamil:
          'மின்னஞ்சல் செயலி திறக்கப்படவில்லை. ஆதரவு மின்னஞ்சலை கைமுறையாகப் பயன்படுத்தவும்.',
      AppLanguage.kannada:
          'ಇಮೇಲ್ ಅಪ್ಲಿಕೇಶನ್ ತೆರೆಯಲು ಸಾಧ್ಯವಾಗಲಿಲ್ಲ. ದಯವಿಟ್ಟು ಬೆಂಬಲ ಇಮೇಲ್ ಅನ್ನು ಹಸ್ತಚಾಲಿತವಾಗಿ ಬಳಸಿ.',
      AppLanguage.malayalam:
          'ഇമെയിൽ ആപ്പ് തുറക്കാൻ കഴിഞ്ഞില്ല. പിന്തുണാ ഇമെയിൽ നേരിട്ട് ഉപയോഗിക്കുക.',
      AppLanguage.marathi:
          'ईमेल अ‍ॅप उघडता आले नाही. कृपया सपोर्ट ईमेल व्यक्तिचलितपणे वापरा.',
      AppLanguage.gujarati:
          'ઇમેઇલ એપ્લિકેશન ખોલી શકાઈ નથી. કૃપા કરીને સપોર્ટ ઇમેઇલનો ઉપયોગ કરો.',
      AppLanguage.bengali:
          'ইমেল অ্যাপ খোলা যায়নি। অনুগ্রহ করে সাপোর্ট ইমেল ব্যবহার করুন।',
      AppLanguage.punjabi:
          'ਈਮੇਲ ਐਪ ਨਹੀਂ ਖੁੱਲ੍ਹ ਸਕੀ। ਕਿਰਪਾ ਕਰਕੇ ਸਹਾਇਤਾ ਈਮੇਲ ਦੀ ਵਰਤੋਂ ਕਰੋ।',
      AppLanguage.odia:
          'ଇମେଲ୍ ଆପ୍ ଖୋଲିପାରିଲା ନାହିଁ। ଦୟାକରି ସମର୍ଥନ ଇମେଲ୍ ବ୍ୟବହାର କରନ୍ତୁ।',
      AppLanguage.assamese:
          'ইমেইল এপ খোল খাব নোৱাৰিলে। অনুগ্ৰহ কৰি সমৰ্থন ইমেইল ব্যৱহাৰ কৰক।',
      AppLanguage.konkani:
          'ईमेल अ‍ॅप उकतें जालें ना. उपकार करून सपोर्ट ईमेल वापरात.',
      AppLanguage.nepali:
          'इमेल एप खोल्न सकिएन। कृपया म्यानुअल रूपमा सपोर्ट इमेल प्रयोग गर्नुहोस्।',
      AppLanguage.meitei:
          'Email app hangdokpa ngamde. Support email manually sijinnabiyu.',
      AppLanguage.mizo:
          'Email app hawng thei lo. Khawngaihin support email hi mahni in hmang mai rawh.',
      AppLanguage.kashmiri:
          'ای میل ایپ نہ کھٔلِتھ۔ مہربٲنی کٔرتھ کٔریو سَپورٹ ای میل پانے اِستعمال۔',
      AppLanguage.ladakhi:
          'Email app ཁ་འབྱེད་མ་ཐུབ། ལག་པས་ support email བེད་སྤྱོད་གནང།',
    },
