...
class _RegionSelectionScreenState extends State<RegionSelectionScreen>
  ...
  Future<void> _selectRegion(AppRegion region) async {
        ...
        AppSnackBar.build(
          content: Text(
            context.strings.localized(
              ...
              kannada:
                  'ಪ್ರದೇಶವನ್ನು ಉಳಿಸಲು ಸಾಧ್ಯವಾಗಲಿಲ್ಲ. ದಯವಿಟ್ಟು ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ.',
              ...
              bengali:
                  'অঞ্চল সংরক্ষণ করা যায়নি। অনুগ্রহ করে আবার চেষ্টা করুন।',
              punjabi:
                  'ਖੇਤਰ ਸੁਰੱਖਿਅਤ ਨਹੀਂ ਹੋ ਸਕਿਆ। ਕਿਰਪਾ ਕਰਕੇ ਦੁਬਾਰਾ ਕੋਸ਼ਿਸ਼ ਕਰੋ।',
              odia: 'ଅଞ୍ଚଳ ସଂରକ୍ଷଣ ହୋଇପାରିଲା ନାହିଁ। ଦୟାକରି ପୁଣି ଚେଷ୍ଟା କରନ୍ତୁ।',
              assamese:
                  'অঞ্চল সংৰক্ষণ কৰিব পৰা নগ’ল। অনুগ্ৰহ কৰি পুনৰ চেষ্টা কৰক।',
              konkani: 'प्रदेश सांबाळपाक जमलो ना. उपकार करून परत प्रयत्न करात.',
              nepali:
                  'क्षेत्र सुरक्षित गर्न सकिएन। कृपया पुन: प्रयास गर्नुहोस्।',
              meitei: 'Region save touba ngamkhide. Amuk hanna hotnabiyu.',
              mizo: 'Bial save thei lo. Khawngaihin ti nawn leh rawh.',
              kashmiri:
                  'علاقہ ہیکہِ نہٕ محفوٗظ کٔرِتھ۔ مہربٲنی کٔرتھ دۆبارٕ کٔریو کوشِش۔',
    ...
    unawaited(NotificationService.instance.syncCurrentPreferences(force: true));
                    ...
                    children: <Widget>[
                      Text(
                        strings.localized(
                          ...
                          tamil:
                              'மாநிலம் / யூனியன் பிரதேசத்தைத் தேர்ந்தெடுக்கவும்',
                          kannada: 'ರಾಜ್ಯ / ಕೇಂದ್ರಾಡಳಿತ ಪ್ರದೇಶವನ್ನು ಆಯ್ಕೆಮಾಡಿ',
                          malayalam:
                              'സംസ്ഥാനം / കേന്ദ്രഭരണ പ്രദേശം തിരഞ്ഞെടുക്കുക',
            ...
            TextField(
              ...
              decoration: InputDecoration(
                hintText: strings.localized(
                  ...
                  malayalam:
                      'സംസ്ഥാനം, കേന്ദ്രഭരണ ప్రദേശം അല്ലെങ്കിൽ ഭാഷ തിരയുക',
