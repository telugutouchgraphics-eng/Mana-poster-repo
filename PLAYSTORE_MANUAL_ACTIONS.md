...
- Add billing test accounts under `License testing`
- Create/publish the in-app subscription products in Play Console
- Upload the new `firestore.rules` and Cloud Functions deployment

## Reviewer instructions draft
- Login is required.
- Reviewer can use Google Sign-In or create an email/password account from inside the app.
- Free-tab poster share/download is behind subscription.
- Restore subscriptions is available from `Profile > Restore subscriptions`.
